...
const objectToClassnames_1 = __importDefault(require("./objectToClassnames"));
describe("objectToClassnames", () => {
    test("should be a function", () => {
        expect(typeof objectToClassnames_1.default).toBe("function");
    });
    test("should return an array", () => {
        const className = objectToClassnames_1.default({
            foo: "bar",
            baz: "bim",
            boof: "boof",
        });
    ...
    test("should return a className array for a given prop", () => {
        const className = objectToClassnames_1.default({ foo: "bar" });
    ...
    test("should return a className string with a custom delimiter", () => {
        const className = objectToClassnames_1.default({ foo: "bar", baz: "bim" }, "___");
    ...
    test("should return a className string with an empty delimiter", () => {
        const className = objectToClassnames_1.default({ foo: "bar", baz: "bim" }, "");
        expect(className).toContain("foobar");
        expect(className).toContain("bazbim");
    });
});
//# sourceMappingURL=objectToClassnames.test.js.map