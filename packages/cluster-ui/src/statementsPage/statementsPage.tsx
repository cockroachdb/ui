...
> {
  ...
  constructor(props: StatementsPageProps) {
    ...
    const defaultState = {
      ...
      tableColumnsSelected: this.props.columns,
  ...
  isColumnSelected = (option: string) => {
    if (
      ...
      return true;
    const selection = this.state.tableColumnsSelected.split(",");
    if (selection.includes(option)) return true;
    return false;
  };
