...
export const terminateSession = ( req: CancelSessionRequestMessage): Promise<CancelSessionResponseMessage> => {
  return fetchData(
...
export const terminateQuery = ( req: CancelQueryRequestMessage): Promise<CancelQueryResponseMessage> => {
  return fetchData(
